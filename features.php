...
<head>
    ...
    <title>IT's Binfinity - Features</title>
...
<body style="font-family:Montserrat;">
    ...
    <div class="container mob-info" style="margin-top: -10em;">
        <div class="My-row">
            <div class="column-md-2 img-iphone-wrapper" style="transform: translateY(10rem); width: 43%;">
                <img class="img-respon slide-tr" src="./assets/Images/new/91.png" >
            </div>

            <div class="column-md-5 text-iphone-wrapper">
                <h2 class="h-1 maintt" style="margin-left: 2rem;"> PUBLIC GALLERY</h2>
                <p class="My-lead padding-t-b-50" style="margin-left: 2rem;"> Our Social Gallery is a unique platform that allows users to share their visual stories and moments, that align with our mission of promoting sustainability.
                </p>
                <a href="#vid">
                    <button class="btnPlant">Get Started
                        <div class="icon-1">
                ...
                <a style="margin-left: 1.2rem;" class="cta" href="https://www.youtube.com/watch?v=T5Us69fSM9M" target="_blank">
    ...
    <div class="scroll-down">
        <a href="#apps-gallery">
            <img class="img-respon" src="https://preview.ibb.co/hNo1pv/scroll.gif" alt="Scroll Down" title="Scroll Down">
        </a>
    </div>
    </section>
    <!-- End Section Nav -->

    <section class="Description-inverse padding-t-b-100"  >
    <div class="container" style="margin-left: 7em; margin-right: 10em;">  
        <h3 class="h-1 padding-t-b-10 " style="font-family:Montserrat; font-size: 3em;"> Add Your Recycling Experience </h3>  
      ...
      ?>  
        <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>  
          <a class="thumbnail fancybox" rel="ligthbox" href="uploads/<?php echo htmlspecialchars($image['image'], ENT_QUOTES, 'UTF-8'); ?>">  
            <img class="img-responsive" alt="" src="uploads/<?php echo htmlspecialchars($image['image'], ENT_QUOTES, 'UTF-8'); ?>" />  
            <div class='text-center'>  
              <small class='text-muted'><?php echo htmlspecialchars($image['title'], ENT_QUOTES, 'UTF-8'); ?></small>  
            </div> </a>  
          <a href="imageDelete.php?id=<?php echo htmlspecialchars($image['id'], ENT_QUOTES, 'UTF-8'); ?>" class="close-icon btn btn-danger" onclick="return confirm('Are you sure you want to delete this image?');"><i class="glyphicon glyphicon-remove"></i></a>  
        </div> <?php } ?>  
    </div> </div> </div> </section>



    <!-- Start  apps-gallery Section  -->
    <section class="apps-gallery " id="apps-gallery">
        <center>
            <div class="container ">
                <div class="My-row-1 padding-t-b-50 txt-center ">
                    <h2 class="h-1 padding-t-b-20 ">Mobile Design</h2>
                </div>

                <div class="My-row slider-num-1 ">
                    <ul class="Slider-screen ">
                        <li class="Slide-1 column-md-12 active ">
                            <div class="My-row ">
                                <div class="slide-img column-md-3 ">
                                    <img class="img-respon" src="./assets/Images/iphone-7.png">

                                </div>
                                <div class="slide-img column-md-3 ">
                                    <img class="img-respon " src="./assets/Images/iphone-12.png">

                                </div>

                                <div class="slide-img column-md-3 ">
                                    <img class="img-respon " src="./assets/Images/iphone-3.png">
                        ...
                        <li class="Slide-1 column-md-12 ">
                            <div class="My-row ">
                                <div class="slide-img-2 column-md-3 ">
                                    <img class="img-respon " src="./assets/Images/iphone-4.png">

                                </div>
                                <div class="slide-img-2 column-md-3 ">
                                    <img class="img-respon " src="./assets/Images/iphone-13.png">

                                </div>

                                <div class="slide-img-2 column-md-3 ">
                                    <img class="img-respon " src="./assets/Images/iphone-15.png">
                                </div>
                            </div>
    ...
    <!-- End  apps-gallery Section -->

    <!-- Start Subscribe  Section  -->
    <section class="Contact wow zoomInLeft " data-wow-duration="2s " data-wow-delay="2s ">
        <div class="Contact-overlay padding-t-b-50 ">


            <div class="container ">
                <div class="My-row txt-center ">

                    <h2 style="color: white;" class="h-1 txt-center ">
                        <span style="color: #6bab78;">IT's </span>Coming Soon
                    </h2>

                    <p class="My-lead padding-t-b-20 ">
                        Get latest news of our Project here.
                    </p>
    ...
    <section class="message txt-center wow slideInRight " data-wow-duration="2s " data-wow-delay="2s ">
        <div class="container ">
            <div class="My-row padding-t-b-100 blc-center ">
                <h2 class="h-1 " style="color: #1d4b38;">
                    Any Ideas?
                </h2>
                <p class="My-lead padding-t-b-50 ">
                    Have feedback, suggestion, or any thought about our website or mobile application? Feel free to contact at <span style="color: #1d4b38; font-weight: 900;">@its.binfinity@gmail.com</span> anytime, we will get back to you in 24 hours.
                </p>
